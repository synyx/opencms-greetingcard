...
/**
 * Describes the interface for transforming 
 * content for sending a mail.
 * @author Florian Hopf, Synyx GmbH & Co. KG
 */
public interface MailTemplate {

    public static final String AUTHOR_NAME = "authorName";
    public static final String AUTHOR_MAIL = "authorMail";
    public static final String RECEIVER_NAME = "receiverName";
    public static final String RECEIVER_MAIL = "receiverMail";
