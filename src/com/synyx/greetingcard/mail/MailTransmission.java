...
/**
 * Interface for the transmission imeplementation.
 * @author Florian Hopf, Synyx GmbH & Co. KG
 */
public interface MailTransmission {

    void sendOrQueue(Greetingcard card) throws MessagingException, DataAccessException;
